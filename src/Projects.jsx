            ...
            <div className="min-h-screen pb-15 bg-fixed bg-center text-white" style={{ backgroundImage: `url("https://wallpapers.com/images/featured/plain-black-background-02fh7564l8qq4m6d.jpg")`, backgroundSize: "cover", backgroundRepeat: "no-repeat" }} >
                ...
                <div className='md:grid grid-cols-[1fr_20fr_1fr]'>
                    ...
                    <div className='pt-10 md:p-25  px-10 flex flex-col gap-15'>
                        ...
                        <div data-aos="fade-down-left" className='md:flex gap-10 space-y-3'>
                        ...
                        <div data-aos="fade-down-right" data-aos-delay="150" className='md:flex gap-10 space-y-3'>
                        ...
                        <div data-aos="fade-down-left" data-aos-delay="200" className='md:flex gap-10 space-y-3'>
                        ...
                        <div data-aos="fade-down-right" data-aos-delay="300" className='md:flex gap-10 space-y-3'>
                        ...
                        <div data-aos="fade-down-left" data-aos-delay="300" className='md:flex gap-10 space-y-3'>
